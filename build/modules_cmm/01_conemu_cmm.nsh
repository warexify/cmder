...
Function check_context_menu_conemu
	StrCpy $1 "shark_conemu_cmd_admin"
	StrCpy $2 ${shark_conemu_cmd_admin}
	Call check_context_menu
	
	StrCpy $1 "shark_conemu_powershell_admin"
	StrCpy $2 ${shark_conemu_powershell_admin}
	Call check_context_menu
	
	StrCpy $1 "shark_conemu_cygwin_admin"
	StrCpy $2 ${shark_conemu_cygwin_admin}
	Call check_context_menu

	StrCpy $1 "shark_conemu_git_bash_admin"
	StrCpy $2 ${shark_conemu_git_bash_admin}
	Call check_context_menu

	StrCpy $1 "shark_conemu_cmd"
	StrCpy $2 ${shark_conemu_cmd}
	Call check_context_menu

	StrCpy $1 "shark_conemu_powershell"
	StrCpy $2 ${shark_conemu_powershell}
	Call check_context_menu

	StrCpy $1 "shark_conemu_cygwin"
	StrCpy $2 ${shark_conemu_cygwin}
	Call check_context_menu

	StrCpy $1 "shark_conemu_git_bash"
	StrCpy $2 ${shark_conemu_git_bash}
	Call check_context_menu
FunctionEnd
