...
##
## @package      remove-font
## @description  Script that uninstalls fonts
## @usage        remove-font.ps1 -Path "C:\folder\with\fonts\to\install"
## ----------------------------------------------------------------------------------------------------
param
(
  [string] $path,
...
{
$usage = @'
Remove-Font-Recursive.ps1
  This script is used to uninstall Windows fonts recursively
  based on a list of fonts present in a folder.

Usage:
  Remove-Font-Recursive.ps1 [-help] [-path "<Font folder path>"]
...
Examples:
  Remove-Font-Recursive.ps1 -path "C:\Custom Fonts"
'@
...
{
  & ((Split-Path $MyInvocation.InvocationName) + "\Remove-Font.ps1") -File "$($font.Name)"
}
